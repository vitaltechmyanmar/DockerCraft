...
export function generateCompose(config: ComposeConfig): string {
  ...
  // version field: omitted when useV2Spec is true (Compose Spec / v2)
  if (!config.useV2Spec) {
...
/**
 * Generate a generic .dockerignore for Compose-based projects.
 * Covers common artifacts from the most popular stacks.
 */
export function generateComposeDockerignore(): string {
  return [
    "# Version control",
    ".git",
    ".gitignore",
